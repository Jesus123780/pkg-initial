...
`;try{r.displayName="FlipCard",r.__docgenInfo={description:"",displayName:"FlipCard",props:{backChild:{defaultValue:{value:"null"},description:"",name:"backChild",required:!1,type:{name:"ReactNode"}},flipped:{defaultValue:{value:"false"},description:"",name:"flipped",required:!1,type:{name:"boolean"}},frontChild:{defaultValue:{value:"null"},description:"",name:"frontChild",required:!1,type:{name:"ReactNode"}},onClick:{defaultValue:{value:"() => {}"},description:"",name:"onClick",required:!1,type:{name:"(() => void)"}},setFlipped:{defaultValue:{value:"(boolean) => { return boolean }"},description:"",name:"setFlipped",required:!1,type:{name:"((boolean: boolean) => void)"}}}}}catch{}export{r as F};
